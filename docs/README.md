...
| Doc | Descripción |
|-----|-------------|
| **INSTALACION_MCP_CURSOR.md** | Instalación del MCP AriadneSpecs para Cursor (configuración, variables, troubleshooting). |
...
| **RESUMEN_RELIC_PARA_OTRO_PROYECTO.md** | Cómo integrar otro proyecto con Ariadne y MCP (`.ariadne-project`, list_known_projects). |
