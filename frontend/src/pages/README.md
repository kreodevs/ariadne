...
- **ProjectChat.tsx** — Chat a nivel proyecto: consulta el grafo de **todos** los repos del proyecto. Las respuestas pueden citar archivos de cualquier repo. Ruta: `/projects/:id/chat`.

## Repositorios

- **RepoList.tsx** — Lista de todos los repositorios.
- **RepoDetail.tsx** — Detalle de un repo (sync, jobs, análisis).
- **RepoChat.tsx** — Chat por repositorio (grafo de un solo repo) + panel de análisis (diagnóstico, duplicados, reingeniería, código muerto, Full Audit). Ruta: `/repos/:id/chat`.
