...
import { api } from '../api';
import type { Credential, Repository, UpdateRepositoryDto } from '../types';
    ...
    <div className="space-y-6">
      ...
      <Card className="max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            Modifica credencial, branch y webhook secret. Provider y repositorio no se pueden cambiar.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
